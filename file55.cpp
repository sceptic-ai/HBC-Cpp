    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Exilium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a exilium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and exilium: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Exilium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Exilium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Exilium Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your exilium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified exilium addresses"));
    ...
    openAction->setStatusTip(tr("Open a exilium: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Exilium Core help message to get a list with possible Exilium Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Exilium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to exilium network", "", count));
    } else {
...
{
    QString strTitle = tr("Exilium Core"); // default title
