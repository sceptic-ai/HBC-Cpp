...
unsigned int nTargetSpacing = 2 * 60; // LendXpress - 120 seconds block time
static const int64_t nInterval = nTargetTimespan / nTargetSpacing;
static const int64_t nDiffChangeTarget = 1;

unsigned int nStakeMinAge = 60 * 60; // 60 minutes min staking age
unsigned int nStakeMaxAge = -1;  // unlimited
unsigned int nModifierIntervalNew = 10 * 60; // LendXpress - time to elapse before new modifier is computed
...
const string strMessageMagic = "LendXpress Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // LendXpress: check proof-of-stake block signature
...
// LendXpress: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LendXpress", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
